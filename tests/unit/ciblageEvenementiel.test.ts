...
describe('ciblage événementiel city-first depuis l’intention', () => {
  ...
  it.each([
    ...
    ['ne surtout pas aller au festival, mais assister au concert', ['concert']],
    ['je ne veux plus voir de match, mais je souhaite assister au spectacle', ['arts_de_la_scene']],
    ['je ne peux vraiment pas assister au concert, mais je peux participer au festival', ['festival']],
    ['je préfère ne jamais participer au festival, puis assister au concert', ['concert']],
    ['je ne souhaite jamais assister au match ni au concert', []],
  ...
  it.each([
    ...
    'ne jamais assister au concert',
    'ne surtout pas assister au concert',
    'ne plus assister au concert',
    'ne vraiment pas assister au concert',
    'ne absolument pas assister au concert',
    'ne jamais aller au festival',
    'ne surtout pas aller au festival',
    'ne plus participer au festival',
    'ne jamais voir un match',
    'ne surtout pas voir le spectacle',
    'je ne veux jamais assister au concert',
    'je ne souhaite surtout pas aller au festival',
    'je ne peux vraiment pas assister au match',
    'je préfère ne jamais participer au festival',
    'jamais une simple ambiance de festival',
    'sans festival',
    'pas de match',
    'aucun spectacle',
